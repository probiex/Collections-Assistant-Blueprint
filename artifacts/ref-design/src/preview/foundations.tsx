...
const TYPE_SCALE = [
  { label: 'Display', className: 'font-serif text-4xl font-medium' },
  { label: 'Heading', className: 'font-serif text-2xl font-medium' },
...
export function OverviewPage() {
  return (
    <div className="space-y-4">
      <section className="overflow-hidden rounded-xl bg-primary p-6 text-primary-foreground">
        <p className="text-xs font-semibold uppercase tracking-[0.18em] opacity-70">
          Quiet confidence
        </p>
        <h2 className="mt-3 max-w-2xl font-serif text-4xl font-medium leading-tight">
          Interfaces that feel grounded, generous, and human.
        </h2>
        <p className="mt-3 max-w-2xl text-sm leading-relaxed opacity-80">
          Pair expressive editorial headings with practical UI copy, warm layered
          surfaces, botanical accents, and information that never feels hurried.
        </p>
      </section>
      ...
      <section className="grid gap-6 rounded-xl border bg-card p-6 text-card-foreground lg:grid-cols-2">
        <div>
          <h2 className="font-serif text-2xl font-medium">Composition guidelines</h2>
          <p className="mt-2 text-sm text-muted-foreground">
            Rules derived from the selected retreat dashboard.
          </p>
        </div>
        <Guidelines
          items={[
            { kind: 'do', text: 'Use Fraunces selectively for display headings, meaningful numbers, and reflective insight copy.' },
            { kind: 'do', text: 'Layer sand backgrounds, white cards, and deep forest feature panels to create calm hierarchy.' },
            { kind: 'do', text: 'Use botanical chart colors consistently and keep data labels concise and human.' },
            { kind: 'dont', text: 'Fill every surface with sage; reserve it for actions, progress, and directional emphasis.' },
            { kind: 'dont', text: 'Use sharp corners, harsh shadows, or dense black dividers where spacing can create structure.' },
          ]}
        />
      </section>
    </div>
  ...
  return (
    <div className="space-y-8 rounded-xl border bg-card p-6 text-card-foreground">
      <section>
        ...
        <p className="mt-4 font-serif text-4xl font-medium">Fourteen quiet days</p>
        <p className="mt-4 text-lg font-semibold">Practical information stays clear in Karla.</p>
        <p className="mt-2 text-sm text-muted-foreground">
