# Consuming ref_design in web apps

Read `artifacts/ref-design/docs/AGENTS.md` first. This guide covers
...
`artifacts/ref-design/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/ref-design/styles.css";
```
...
`node_modules/@workspace/ref-design/src/components` to `content`.
...
import {
  toast,
  useToast,
} from "@workspace/ref-design/hooks/use-toast";
```
...
`@workspace/ref-design/components/ui/button`. Run the app's typecheck
