# Consuming ref_design in Expo apps

Read `artifacts/ref-design/docs/AGENTS.md` first. React Native does
...
`artifacts/ref-design/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/ref-design/tokens";
...
```tsx
import { nativeTheme } from "@workspace/ref-design/lib/native-theme";
import { useColors } from "@workspace/ref-design/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/ref-design/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/ref-design/components/native/badge";
import { Button } from "@workspace/ref-design/components/native/button";
import { Card } from "@workspace/ref-design/components/native/card";
```
...
Import and render
`@workspace/ref-design/components/native/button`, then run Expo
