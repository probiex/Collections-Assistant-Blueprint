# Migrating Expo UI to ref_design

Read `artifacts/ref-design/docs/AGENTS.md` and
`artifacts/ref-design/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/ref-design/lib/native-theme` and
  `@workspace/ref-design/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/ref-design/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/ref-design` and retains only
