# Migrating web UI to ref_design

Read `artifacts/ref-design/docs/AGENTS.md` and
`artifacts/ref-design/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/ref-design/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/ref-design/lib/utils`
- `@/hooks/use-toast` → `@workspace/ref-design/hooks/use-toast`
