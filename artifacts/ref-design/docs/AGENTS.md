...
workspace package (`@workspace/ref-design`): other artifacts depend
...
- The visual source is the selected Bali Retreat Expense Tracker mockup. Its
  reusable language is warm sand surfaces, deep forest anchors, sage actions,
  terracotta/botanical data colors, Fraunces display type, Karla UI type,
  pill controls, generous rounded cards, and gentle motion.
- The source is a composed application mockup rather than a component library,
  so the complete stock component catalog is retained and themed from the
  extracted tokens instead of treating app-specific dashboard compositions as
  reusable primitives.
...
`@workspace/ref-design/components/...`. Never use a `@/` alias inside
...
for `@workspace/ref-design` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/ref-design` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/ref-design/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/ref-design/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/ref-design/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/ref-design/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/ref-design/docs/migrating-expo.md`
